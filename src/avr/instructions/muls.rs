...
mod test {
  ...
  #[test]
  fn muls_r19_r20_returns_0x03a8() {
    let testbed = init(vec![(19, 0x12), (20, 0x34)]);

    let op = super::Muls::new(0b1001_1100_0011_0100);
  ...
  #[test]
  fn muls_r19_r20_returns_0x0000() {
  ...
  #[test]
  fn muls_r19_r20_returns_0x0042() {
    ...
    let registers = testbed.registers.borrow();
    let status_register = testbed.status_register.borrow();
    assert_eq!(registers.get(0), 66);
    assert_eq!(registers.get(1), 0);
    assert_eq!(status_register.get_carry(), 0);
    assert_eq!(status_register.get_zero(), 0);
  }

  #[test]
  fn muls_r3_r4_returns_0xffe2() {
