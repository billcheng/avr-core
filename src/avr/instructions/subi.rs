...
mod test {
  ...
  #[test]
  fn subi_r30_0x0f_0x1() {
    let testbed = init(vec![(30, 0x0f)]);

    let op = super::Subi::new(0b0101_0000_1110_0001);
  ...
  #[test]
  fn subi_r30_0x10_0xf() {
    let testbed = init(vec![(30, 0x10)]);

    let op = super::Subi::new(0b0101_0000_1110_1111);
    op.execute(super::InstructionData {
      registers: testbed.registers.clone(),
      status_register: testbed.status_register.clone(),
      ..testbed
  ...
  #[test]
  fn subi_r30_0x10_0x10() {
    let testbed = init(vec![(30, 0x10)]);

    let op = super::Subi::new(0b0101_0001_1110_0000);
    op.execute(super::InstructionData {
      registers: testbed.registers.clone(),
      status_register: testbed.status_register.clone(),
      ..testbed
  ...
  #[test]
  fn subi_r30_0x10_0x11() {
    let testbed = init(vec![(30, 0x10)]);

    let op = super::Subi::new(0b0101_0001_1110_0001);
    op.execute(super::InstructionData {
      registers: testbed.registers.clone(),
      status_register: testbed.status_register.clone(),
      ..testbed
