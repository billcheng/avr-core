...
mod test {
  ...
  fn sbis_31_7_doesnt_skip() {
    ...
    let op = super::Sbis::new(0b1001_1011_1111_1111, 0x00, &Opcode::new());
  ...
  fn sbis_31_7_skip_2_word() {
    ...
    let op = super::Sbis::new(0b1001_1011_1111_1111, 0b1001_0100_0000_1110, &Opcode::new());
    let result = op.execute(super::InstructionData {
      pc: 0x0005,
      ..testbed
    });
